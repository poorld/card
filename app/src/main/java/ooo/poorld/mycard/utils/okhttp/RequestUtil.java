package ooo.poorld.mycard.utils.okhttp;
...
class RequestUtil {
    ...
    private void setPostFile() {
        if(mFile != null && mFile.exists()) {
            ...
            MultipartBody multipartBody = new MultipartBody.Builder()
                    .addPart(part)
                    .build();
            mRequestBuilder.post(new ProgressMultipartBody(multipartBody, mCallBack));
     ...
     * 自定义RequestBody类，得到文件上传的进度
     */
    private static class ProgressMultipartBody extends RequestBody {
        //实际的待包装请求体
        ...
        ProgressMultipartBody(MultipartBody requestBody, CallBackUtil callBack) {
            this.requestBody = requestBody;
            this.callBack = callBack;
        }
